...
echo "-b name - use config.sh to checkout and tag repos with branch named name"
echo "-a - setup all available repos: $allrepos"
echo "-c - setup repos used by cfastbot:  $cfastbotrepos"
echo "-D - allow push access to firemodels"
echo "-e - erase repos"
echo "-f - setup repos used by firebot:  $firebotrepos"
echo "-F - setup freeglut"
echo "-h - display this message"
echo "-K repo - clone repo named repo, erase first"
echo "-s - setup repos used by smokebot: $smokebotrepos"
