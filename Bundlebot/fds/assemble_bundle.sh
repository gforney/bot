...
fds_bundle=$REPO_ROOT/bot/Bundlebot/fds/fds_forbundle
...
MAKEINSTALLER=$REPO_ROOT/bot/Bundlebot/fds/make_installer.sh
...
copyfdscase=$REPO_ROOT/bot/Bundlebot/fds/copyfdscase.sh
copycfastcase=$REPO_ROOT/bot/Bundlebot/fds/copycfastcase.sh
