...
# compare images generated by this smokebot run with a base set in the fig repo
   TOLERANCE=0.2
   cd $smokebotdir/../../fig/smv/Reference_Figures/Default
   REFDIR=`pwd`
   cd $botrepo/Smokebot
   echo Comparing images
   ../Firebot/compare_images.sh $REFDIR $SMV_SUMMARY_DIR/images $SMV_SUMMARY_DIR/diffs/images $TOLERANCE >& $OUTPUT_DIR/stage5_compare_images
